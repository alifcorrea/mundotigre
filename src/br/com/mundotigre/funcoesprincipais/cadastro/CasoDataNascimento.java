...
public class CasoDataNascimento {
	...
	@Test 
	public void testarDataNascimento(WebDriver driver, Logger logger, Usuario usuario, String link, InteracoesNavegador interacoesNavegador, FuncoesMT funcoesMT, FuncoesCadastro funcoesCadastro){ 
		...
		while(i<=max){
			...
			if(funcoesCadastro.cadastroRealizado(driver)) {
				...
				funcoesMT.logCampoOK(driver, logger, nomeCampo, usuario.getDataNascimento());
				...
				funcoesMT.logCampoErro(driver,logger, nomeCampo, usuario.getDataNascimento());
