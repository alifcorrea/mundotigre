...
public class CasoTimeCoracao {
	 ...
	 @Test 
	 public void testarTimeCoracao(WebDriver driver, Logger logger, Usuario usuario, String link, InteracoesNavegador interacoesNavegador, FuncoesCadastro funcoesCadastro){		 
		 System.out.println("\n-----------------------------Teste Time Coração-------------------------------");
