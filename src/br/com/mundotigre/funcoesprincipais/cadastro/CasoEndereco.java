...
public class CasoEndereco {
	...
	@Test 
	public void testarEndereco(WebDriver driver, Logger logger, Usuario usuario, String link, InteracoesNavegador interacoesNavegador, FuncoesMT funcoesMT, FuncoesCadastro funcoesCadastro){		 
		...
		while(i<=max){	
			...
			if(funcoesCadastro.cadastroRealizado(driver)) {	
				...
				funcoesMT.logCampoOK(driver, logger, nomeCampo, usuario.getEndereco());
				quantidadeAcertos++;
			}else {
					funcoesMT.logCampoErro(driver, logger, nomeCampo, usuario.getEndereco());
					quantidadeErros++;
				}
