...
public class CasoEmpresa {
	...
	@Test 
	public void testarEmpresa(WebDriver driver, Logger logger, Usuario usuario, String link, InteracoesNavegador interacoesNavegador, FuncoesMT funcoesMT, FuncoesCadastro funcoesCadastro){		 
