...
public class CasoProfissaoDetalhe {
	...
	@Test 
	public void testarProfissaoDetalhe(WebDriver driver, Logger logger, Usuario usuario, String link, InteracoesNavegador interacoesNavegador, FuncoesMT funcoesMT, FuncoesCadastro funcoesCadastro){
		...
		if(funcoesCadastro.cadastroRealizado(driver)) {
			...
			funcoesMT.logCampoOK(driver, logger, nomeCampo, usuario.getProfissaoDetalhe());
			quantidadeAcertos++;
				
		}else{
				funcoesMT.logCampoErro(driver, logger, nomeCampo, usuario.getProfissaoDetalhe());
				quantidadeErros++;		
			}
